...
6.  Set up your remote repository.
    ...
    Go to \[GitHub\]([https://github.com](https://github.com/)) and create a new repository without README, .gitignore, or license (See @fig-copy-ssh)
...
In this final section, you’ll create a simple plot using ggplot2, commit the change, then learn how to undo the commit while keeping your changes safe.
...
4.  Load your dataset using `data()` or `read.csv()`, depends on the file's format.

5.  Use ggplot2 to create a chart. In this example, I’ll use a line chart to visualise the relationship between two variables (See @fig-vis).
...
Assume you’ve committed your plot, but then realize you made a mistake. For example,you forgot to include a title or other details (See @fig-reset). You can undo the last commit without losing your changes by running:
