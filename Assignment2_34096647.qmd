...
5.  Add the data folder in your project folder.

6.  Use this command to amend previous commit, and push it (See @fig-amend):
...
1.  Assuming that you have made changes in both main branch and new branch (in the same line). Merge the changes in main from the new branch:
...
4. Save the changes and push it with meaningful commit message. Chech the git status in GitHub (See @fig-gitstatus)
